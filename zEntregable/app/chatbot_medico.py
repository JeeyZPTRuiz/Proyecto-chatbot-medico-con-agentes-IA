...
# Cargamos las variables del archivo .env oculto
load_dotenv()

def configurar_chatbot():
    # Ahora siempre encontrara la clave
...
def procesar_consulta_paciente(modelo, mensaje_usuario):
    try:
        ...
        print(f"============== ERROR DE GEMINI: {error} ==============")
        
        mensaje_error = "Lo sentimos, ha ocurrido un error al procesar tu consulta..."
